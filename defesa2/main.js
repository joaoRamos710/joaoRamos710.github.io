...
function realizarCompra() {
    ...
    const dadosCompra = prepararDadosCompra(produtosSelecionados, estudanteDeisi, cupaoDesconto, morada);
...
function prepararDadosCompra(produtosSelecionados, estudante, cupao, morada) {
    return {
...
function exibirResultado(total, referencia, morada) {
    ...
    document.getElementById("address").textContent = `Morada Compra: ${morada}`;
}
